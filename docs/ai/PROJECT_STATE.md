...
- [x] App integration audit/design complete (Patch 7G-8C — repository/worker/scanner/backfill/core-api integration design documented; implementation unblocked; 7G-8C-1 done, pending 7G-8C-2 through 7G-8C-4)
...
| 7G-8C | App integration audit/design complete (Patch 7G-8C planning only); implementation partially complete: 7G-8C-1 done, pending separate approved prompts (7G-8C-2 through 7G-8C-4) | After 7G-8B |
...
| 7G-8C-2 to 7G-8C-4 | Worker refactor + scanner/backfill skip logging + core-api status LEFT JOIN — pending separate approved prompts | After 7G-8C-1 |
...
* No services, tests, or runtime Python files modified.
* No app code integration: worker/scanner/backfill do not write skip rows; `/grading/status` does not read `grading_skip_log`.
