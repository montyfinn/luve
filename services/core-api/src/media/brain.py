...
class LLMProcessor:
    ...
    SYSTEM_PROMPT = (
        ...
        "'Sorry?', 'Can you repeat?', 'Again please'), rephrase your previous "
        "question in simpler English. Do not treat it as a question about yourself "
        "and do not answer it literally.\n"
